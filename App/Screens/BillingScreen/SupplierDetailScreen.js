...
const SupplierDetailScreen = props => {
  ...
  const renderItem = ({item}) => {
    return (
      <View style={{borderWidth:3,borderColor:'#fff',borderRadius:10,backgroundColor: '#f0f0f5', shadowColor:"#000"}}>
        <View style={styles.customerListContainer}>
          ...
          <View style={styles.transaction}>
            <View style={styles.textContainer}>
              <Text style={styles.sendTextTransaction}>₹{item.netAmountSend}</Text>
            </View>
            <View style={styles.textContainers}>
              <Text style={styles.receiveTextTransaction}>₹{item.netAmountReceive}</Text>
            </View>
          </View>
        </View>
  ...
  return (
    <KeyboardAvoidingView style={styles.containers}>
      <View style={styles.CustomerName}>
        <Text style={styles.customerText}>Supplier Name</Text>
      </View>
      ...
      <View style={styles.buttonOuterContainer}>
          <TouchableOpacity
            ...
            onPress={() => {
              props.navigation.navigate(StringC.CUSTOMER_BILLS_STACK,{yh:'ssdsdsd'});
            }}>
